...
<head>
    ...
    <title>شركة إيجل لإيجار السيارات</title>
    <!-- Bootstrap CSS -->
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                            <ul class="nav navbar-nav menu_nav justify-content-center">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="index.html#about">إيجل</a>
                                </li> 
                                <li class="nav-item">
                                    <a class="nav-link" href="index.html#models">نماذج السيارات</a>
                                </li> 
                                <li class="nav-item">
                                    <a class="nav-link" href="index.html#services">خدماتنا</a>
                                </li> 
                                <li class="nav-item">
                                    <a class="nav-link" href="index.html#advant">عروضنا</a> 
                                </li> 
                                <li class="nav-item">
                    ...
                    <header class="section-header">
                        ...
                        if (!empty($_POST)){
                            ...
                            if(!preg_match($regex, $_POST['email'])){
                                ...
                                mail($email,"eagle for rental Landing Page SMS",$message,"From: {$_POST["name"]} <{$_POST["email"]}>");
