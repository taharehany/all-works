...
$(document).ready(function () {
    ...
    $('.service-style-three .more1').on('click', function () {
        
        $('#single_service1').slideDown(1000);
        $('#single_service2').slideUp(500);
        $('#single_service3').slideUp(500);
        
    });
    
    $('.service-style-three .more2').on('click', function () {
        
        $('#single_service2').slideDown(1000);
        $('#single_service1').slideUp(500);
        $('#single_service3').slideUp(500);
        
    });
    
    $('.service-style-three .more3').on('click', function () {
       
        $('#single_service3').slideDown(1000);
        $('#single_service1').slideUp(500);
        $('#single_service2').slideUp(500);
    ...
    iframe: {
        patterns: {
           youtube: {
              index: 'youtube.com/', 
              id: 'v=', 
              src: 'https://www.youtube.com/embed/7xrN2yUo7-k' 
          }
        }
    }
});
...
function thmOwlCarousel() {
    ...
    if ($('.cer-carousel').length) {
        $('.cer-carousel').owlCarousel({
            loop: true,
            margin: 30,
            nav: true,
            navText: [
