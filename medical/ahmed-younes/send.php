...
<html lang="ar">
    <head>
        <meta charset="utf-8">
        <title>عيادة دكتور أحمد يونس لطب الأسنان</title>
    ...
    <body>
                        ...
                        <h3>
                            ...
                            if (!empty($_POST)){
                                ...
                                if(!preg_match($regex, $_POST['email'])){
                                    ...
                                    mail($email,"dr-ahmed younes landing page SMS",$message,"From: {$_POST["name"]} <{$_POST["email"]}>");
	   ...
	   <!--================ Footer Start =================--> 
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="footer-copyright text-center">
                            <p>جميع الحقوق محفوظة &copy; 2018. تصميم وتطوير <br /><a href="http://advertizeragency.com/" target="_blank">شركة أدفرتيزر للتسويق الإلكتروني</a></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- strat fixed mobile -->
        <div class="con_icons d-block d-sm-none" dir="rtl">
            <div class="row">
                <div class="col-6">
                    <a class="fixed_mobile" href="tel:0591000704"><p><i class="fa fa-phone"></i> اتصل الآن </p></a>
                </div>    
                <div class="col-6">
                    <div class="contain">
                        <a href="https://api.whatsapp.com/send?phone=9660591000704">
                            <div class="fixed_whats"></div>   
                        </a>    
                    </div>    
                </div>
            </div>
