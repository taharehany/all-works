...
<html lang="ar">
    <head>
        <meta charset="utf-8">
        <title>عيادة دكتور بهاء الدين | مركز فاميلي لطب الأسنان</title>
                            ...
                            <div class="col-lg-auto col">
                                <div class="header-contacts" dir="rtl">
                                    ...
                                    <span class="header-contacts__inner">كلمنا الآن!
                                        <a class="header-contacts__number" href="tel:01224631111" dir="ltr">01224631111
                                        </a>
                                    </span>
                                </div>
                            </div>
                            ...
                            <h3>
                                ...
                                if (!empty($_POST)){
                                    ...
                                    if(!preg_match($regex, $_POST['email'])){
                                        ...
                                        mail($email,"dr-bahaa landing page SMS",$message,"From: {$_POST["name"]} <{$_POST["email"]}>");
            ...
            <footer class="footer-area bg-img bg-overlay-2 section-padding-100-0">
                <div class="container">
                    <div class="copywrite-content">
                        <p>جميع الحقوق محفوظة &copy; تصميم وتطوير<br /><a href="https://advertizeragency.com/" target="_blank">شركة ادفرتيزر للتسويق الإلكتروني</a></p>
                    </div>
                </div>
            </footer>
            <!-- Footer Area End -->
